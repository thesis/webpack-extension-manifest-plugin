...
### `config.transform`
Type: `Function`
Default: `(manifestJSON) => manifestJSON`
Description: *Provide an optional function to transform the manifest. The function should take an object representing the extended manifest JSON, as well as an optional second argument exposing Webpack's compilation object. It should return an object representing the new manifest JSON. The return should be easily `JSON.stringify()`d.*
